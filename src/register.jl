...
macro register_univariate(f, df, ddf)
    return esc(
        quote
            ...
            @inline (n::ExaModels.Node1{typeof($f),Base.Ref{I}})(i, x, θ) where {I} =
                $f(n.inner[](i, x, θ))
        end,
    )
end
...
macro register_bivariate(f, df1, df2, ddf11, ddf12, ddf22)
    return esc(
        quote
            ...
            @inline (n::ExaModels.Node2{typeof($f),I1,I2})(i, x, θ) where {I1<:Base.Ref,I2<:Base.Ref} =
                $f(n.inner1[](i, x, θ), n.inner2[](i, x, θ))
            @inline (n::ExaModels.Node2{typeof($f),I1,I2})(i, x, θ) where {I1,I2} = begin
                $f(n.inner1(i, x, θ), n.inner2(i, x, θ))
            end
